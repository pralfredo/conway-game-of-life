// CS231 
// Pramithas Upreti
// ConfigurableColoredSimulation.java
// Section A
// Project 2--> Simulation of Conway's Game of Life 
// 02/17/2023

public class ConfigurableColoredSimulation extends ColoredLifeSimulation {

	/*
	 * Constructor that inherits properties from ColoredLifeSimulation
	 */
	public ConfigurableColoredSimulation() {
		super();
	}

	/**
	 * Modified main function that overrides the one from ColoredLifeSimulation
	 */
	public static void main(String[] args) throws InterruptedException, NumberFormatException {
		...
		// this class
		ColoredLifeSimulation simulation = new ColoredLifeSimulation(width, height, timeStep, chance, scale);
		while (true) {
			simulation.mainLoop();
		}
	}
